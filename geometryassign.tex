...
\begin{enumerate}
 ...
 \item A mint moulds four types of copper coins A,B,C and D whose diameters vary from 0.5 cm to 5 cm.The first coin A has a diameter of 0.7 cm.The second coin B has double the diameter of coin A and from then onwards the diameters increase by 50\%. Thickness of each coin is 0.25 cm.
     \begin{figure}[ht]
         \centering
         \includegraphics[width=0.7\columnwidth]{/storage/emulated/0/Pictures/SAVE_20230924_225414.jpg}
         \caption{}
         \label{}
     \end{figure}
    ...
    \item \begin{enumerate}
      \item In Figure \ref{fig:sample}, from a solid cube of side 7 cm, a cylinder of radius 2.1 cm and height 7 cm is scooped out. Find the total surface area of the remaining solid .
       \begin{figure}[ht]
           \centering
            \includegraphics[width=0.3\columnwidth]{/storage/emulated/0/Pictures/SAVE_20230924_225403.jpg}
            \caption{}
            \label{fig:sample}
       \end{figure}
                               $$OR$$
    ...
    \item A solid piece of metal in the form of a cuboid of dimensions 11 cm x 7 cm x 7 cm is melted to form n number of solid spheres of radii $\frac{7}{2}$ cm each. Find the value of n.
     ...
     \begin{figure}[ht]
         \centering
          \includegraphics[width=0.5\columnwidth]{/storage/emulated/0/Pictures/SAVE_20230924_225336.jpg}
         \caption{}
         \label{}
     \end{figure}
     ...
     \item
       ...
       \end{enumerate}
            ...
            \begin{figure}[ht]
                \centering
                \includegraphics[width=0.5\columnwidth]{/storage/emulated/0/Pictures/SAVE_20230924_225409.jpg}
                \caption{}
                \label{}
            \end{figure}
            ...
            \begin{figure}[ht]
                \centering
                \includegraphics[width=0.5\columnwidth]{/storage/emulated/0/Pictures/SAVE_20230924_225345.jpg}
                \caption{}
                \label{}
            \end{figure}
            \begin{enumerate}
           ...
           \begin{figure}[ht]
                \centering
                \includegraphics[width=0.5\columnwidth]{/storage/emulated/0/Pictures/SAVE_20230924_225350.jpg}
                \caption{}
                \label{}
            \end{figure}
      ...
      \begin{figure}[ht]
            \centering
              \includegraphics[width=0.7\columnwidth]{/storage/emulated/0/Pictures/SAVE_20230924_225357.jpg}
            \caption{}
            \label{}
        \end{figure}
